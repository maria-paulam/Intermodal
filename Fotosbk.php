...
if (!$stmt = @ociparse($db,$sql)) 
    ...
    if (!@OCIexecute($stmt)) {
	        ...
	        while (ocifetch($stmt)) 
		{
			...
			echo  "<a class=\"example-image-link\" href=\"VerFoto.php?id=$idarchivo\"  width=\"300\" height=\"300\"   data-lightbox=\"example-set\" data-title=\"Ingreso ".$_GET['ID_MOVIMIENTO']." Fecha 2014-02-10\"><img class=\"example-image\" src=\"VerFoto.php?id=$idarchivo\"  width=\"200\" height=\"100\"/></a>";
